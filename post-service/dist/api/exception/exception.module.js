...
const http_exception_service_1 = require("./http-exception.service");
let ExceptionModule = class ExceptionModule {
};
ExceptionModule = __decorate([
    (0, common_1.Module)({
        controllers: [],
        providers: [http_exception_service_1.HttpExceptionService],
        exports: [http_exception_service_1.HttpExceptionService]
    })
], ExceptionModule);
